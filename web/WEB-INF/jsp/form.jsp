<%-- 
    Document   : form
    Created on : 25 Σεπ 2019, 8:55:39 μμ
    Author     : ALEX
--%>
        ...
        <div class="container">
            <div class="contact-form" >
                <div class="input-fields" >
                    <spring:form modelAttribute="emptyTr" action="${pageContext.request.contextPath}/trainer/insert.htm" method="POST">
                        ...
                        <div class="msg" >
                            ...
                            <!--                            <a href="#" type="submit" class="btn--animated">
                                                        <span></span>
                                                        <span></span>
                                                        <span></span>
                                                        <span></span>
